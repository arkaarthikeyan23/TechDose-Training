public class RangeGCDQuery {
    ...
    public static void buildSegTree(int[] arr, int st_index, int start, int end){
        ...
        st[st_index] = GCD(st[2*st_index], st[2*st_index+1]);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("RangeGCD(2,4): "+query(2,4,st_index, start, end));
        System.out.println("RangeGCD(1,4): "+query(1,4,st_index, start, end));
        System.out.println("RangeGCD(3,3): "+query(3,3,st_index, start, end));
